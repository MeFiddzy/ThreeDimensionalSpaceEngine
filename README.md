...
A small rendering engine for 3D and 2D built using [OpenGL](https://www.opengl.org/) via [GLFW](https://www.glfw.org/) and [GLM](https://github.com/g-truc/glm).
## Abstracted Features
...
```
## AI Use
AI did not write a single line of code in the project.
