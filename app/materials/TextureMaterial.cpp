...
TextureMaterial::TextureMaterial(const Texture &texture, glm::mat4 proj, const UInt slot) {
    m_texture = texture;
    m_slot = slot;

    m_shader = Shader("texture_shader.glsl");
...
TextureMaterial::TextureMaterial(Texture &&texture, glm::mat4 proj, const UInt slot) {
